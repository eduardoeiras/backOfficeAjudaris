                ...
                <div id="add" class="modal fade">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <form method="POST" action="escolas/add" onsubmit="return verificaValidadeMoradas(true)">
                                @csrf
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="disponibilidade" class="form-control" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="codPostalAdd" name="codPostal" class="form-control" maxlength="10">
                                        <label>Segundos dígitos</label>
                                        <input type="number" id="codPostalRuaAdd" name="codPostalRua" class="form-control" maxlength="6">
                                    </div>

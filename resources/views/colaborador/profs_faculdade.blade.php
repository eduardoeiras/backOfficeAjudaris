                ...
                <div id="add" class="modal fade">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form method="POST" action="profsFaculdade/add" onsubmit="return verificaValidadeMoradas(true)">
                                @csrf
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label>Cargo</label>
                                        <input type="text" name="cargo" class="form-control" maxlength="30" requied>
                                    </div>
                                    <div class="form-group">
...
<script src="{{ asset('js/paginas/pagProfsFacul.js') }}"></script>
</html>
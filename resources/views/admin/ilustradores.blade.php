                                    ...
                                    <?php
                                        if(isset($data)) {
                                            foreach($data as $linha) {
                                                ...
                                                $dados = $dados.verificaNull($linha["entidade"]->volumeLivro);
                                                ...
                                                $dados = $dados.'<td>
                                                        <a href="#edit" class="edit" data-toggle="modal" onclick="editar('.$linha["entidade"]->id_ilustradorSolidario.')"><i
                                                                class="material-icons" data-toggle="tooltip"
                                                                title="Edit">&#xE254;</i></a>
                                                        <a href="#delete" class="delete" data-toggle="modal" onclick="remover('.$linha["entidade"]->id_ilustradorSolidario.')"><i
                                                                class="material-icons" data-toggle="tooltip"
                                                                title="Delete">&#xE872;</i></a>
                                                    </td>';
                                                $dados = $dados.'</tr>';
                        ...
                        <div class="modal-content">
                            <form method="POST" action="ilustradores/add">
                                ...
                                <div class="modal-body">
                                    <label style="font-size: 18px">Informações do Ilustrador Solidário</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="volumeLivro" class="form-control" maxlength="50">
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="modal-content">
                            <form method="POST" action="" id="formEditar">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label>Volume do Livro</label>
                                        <input type="text" id="volumeLivro" name="volumeLivro" class="form-control" maxlength="50">
                                    </div>
                                    <div class="form-group">
                                        <label>Disponibilidade</label>

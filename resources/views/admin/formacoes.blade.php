                            ...
                            <form method="POST" action="formacoes/add">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nomeInstituicao" class="form-control" maxlength="50" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
                        ...
                        <div class="modal-content">
                            <form method="POST" action="" id="formEditar">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label>Nome da Instituição</label>
                                        <input type="text" id="nomeInstituicao" name="nomeInstituicao" class="form-control" maxlength="50" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>

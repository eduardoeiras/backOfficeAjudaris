                            ...
                            <form id="formAdd" enctype="multipart/form-data"> 
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group" style="margin-right: 3%">
                                        <label for="anoHistoria">Ano</label>
                                        <div>
                                          <input class="form-control" type="text" name="anoHistoria" id="anoHistoria" autocomplete="off" required>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <label>História</label>
                                        <input type="file" id="historia" name="historia" class="form-control-file">
                                        <br>
                            ...
                            <form method="POST" id="formEditar" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="edit_ano" class="form-control" type="text" name="anoHistoria" readonly required>
                                    </div>
                                    <div class="form-group">
                                        <label>História</label>
                                        <input id="edit_historia" type="file" id="edit_historia" name="historia" class="form-control">
                                    </div>

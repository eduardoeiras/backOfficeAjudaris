...
Route::get('admin/getTipoUser', 'UtilizadorController@getTipoUser')->middleware(['checkLogInAdmin']);
...
Route::get('admin/professores/getAll', 'ProfessorController@getAll')->middleware(['checkLogInAdmin']);
...
Route::get('admin/escolas/getAll', 'EscolaSolidariaController@getAll')->middleware(['checkLogInAdmin']);
...
Route::get('admin/ilustradores/getAll', 'IlustradorSolidarioController@getAll')->middleware(['checkLogInAdmin']);
...
Route::get('admin/contadores/getAll', 'ContadorHistoriaController@getAll')->middleware(['checkLogInAdmin']);
...
Route::get('admin/entidades/getAll', 'EntidadeOficialController@getAll')->middleware(['checkLogInAdmin']);
...
Route::get('admin/juris/getAll', 'JuriController@getAll')->middleware(['checkLogInAdmin']);
...
Route::get('admin/profsFaculdade/getAll', 'ProfessorFaculdadeController@getAll')->middleware(['checkLogInAdmin']);
...
Route::get('admin/formacoes/getAll', 'FormacaoController@getAll')->middleware(['checkLogInAdmin']);
...
Route::post('colaborador/projetos/submeterFicheiro', 'FicheiroController@receberFicheiro')->middleware(['CheckLogInColaborador']);

Route::get('colaborador/projetos/getLastId', 'ProjetoController@getLastId')->middleware(['CheckLogInColaborador']);
...
Route::get('colaborador/professores/getAll', 'ProfessorController@getAll')->middleware(['CheckLogInColaborador']);
...
Route::get('colaborador/escolas/getAll', 'EscolaSolidariaController@getAll')->middleware(['CheckLogInColaborador']);
...
Route::get('colaborador/ilustradores/getAll', 'IlustradorSolidarioController@getAll')->middleware(['CheckLogInColaborador']);
...
Route::get('colaborador/contadores/getAll', 'ContadorHistoriaController@getAll')->middleware(['CheckLogInColaborador']);
...
Route::get('colaborador/entidades/getAll', 'EntidadeOficialController@getAll')->middleware(['CheckLogInColaborador']);
...
Route::get('colaborador/juris/getAll', 'JuriController@getAll')->middleware(['CheckLogInColaborador']);
...
Route::get('colaborador/profsFaculdade/getAll', 'ProfessorFaculdadeController@getAll')->middleware(['CheckLogInColaborador']);
...
Route::get('colaborador/formacoes/getAll', 'FormacaoController@getAll')->middleware(['CheckLogInColaborador']);
...
Route::get('colaborador/gerirEscola/getProfessores/{id}', 'EscolaSolidariaController@getProfessores')->middleware(['CheckLogInColaborador']);
...
Route::post('colaborador/gerirEscola/changeInterlocutor/{id}-{id_escola}', 'EscolaSolidariaController@changeInterlocutor')->middleware(['CheckLogInColaborador']);
